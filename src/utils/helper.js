import { DASHBOARD_CACHE_DURATION_HOURS } from "./globalCon";

// Set into Local Storage with Timestamp
export const setDashboardDataInLocalStorage= (arr) =>{
    let dt =new Date();
    localStorage.setItem("dashboardMoviesData",JSON.stringify(arr));
...
//To Check if we can Using Cache Storage for Dashboard Lists
